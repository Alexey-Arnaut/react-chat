...
export const ChatForm: React.FC = () => {
    ...
    const onSuccesRecording = async (stream: any) => {
        ...
        recorder.ondataavailable = async (e: any) => {
            ...
            const audioRef = ref(
                storage,
                `audio/${new Date().getTime()} - ${file.name}`
            );
        ...
        <form className="chat__form" onSubmit={handleSubmit}>
            ...
            {selectedMessage &&
                <div className='chat__form-buttons'>
                    <button onClick={closeEdit} className='chat__form-button chat__form-btn'>
                    ...
                    <button onClick={saveChange} className='chat__form-button chat__form-btn'>
                    ...
                    <button onClick={removeMessage} className='chat__form-button chat__form-remove chat__form-btn'>
